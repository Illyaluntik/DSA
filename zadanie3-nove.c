// zadanie3.c -- Stanislav Jakúbek, 13.11.2017 16:02
...
int *zachran_princezne(char **mapa, int n, int m, int t, int *dlzka_cesty) {
  int *returnPole = NULL, pomPole[6] = {2147483647}, minValue=2147483647, minPos = 0;
  int a, b, g, h, i, j, k, l;
  ...
  // Vypis polohy draka a jednotlivych princezien
  /*printf("DRAK: %d %d\n", drak->a, drak->b);
  printf("P1: %d %d\n", dp1->a, dp1->b);
  printf("P2: %d %d\n", dp2->a, dp2->b);
  printf("P3: %d %d\n", dp3->a, dp3->b);*/
  
  //printf("DC: %d pomPole[minPos]: %d\n", *dlzka_cesty, pomPole[minPos]);
...
int main() {
  ...
  mapa[0][0] = 'P';mapa[0][1] = 'N';mapa[0][2] = 'P';
  mapa[1][0] = 'H';mapa[1][1] = 'N';mapa[1][2] = 'H';
  mapa[2][0] = 'P';mapa[2][1] = 'N';mapa[2][2] = 'C';
  mapa[3][0] = 'C';mapa[3][1] = 'H';mapa[3][2] = 'D';

  int *cesta = zachran_princezne(mapa, n, m, 20, &dlzka_cesty);
  printf("DC: %d\n", dlzka_cesty);
